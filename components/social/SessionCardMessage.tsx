...
export default function SessionCardMessage({ message, onReact, onReply, onDelete, onCopy, isOwn, readCount = 0, replyContent, onReplyTap, activeActionId, onActionOpen }: SessionCardMessageProps) {
