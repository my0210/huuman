  ...
  return (
    <div className="flex h-dvh flex-col bg-zinc-950">
      <header className="flex-none border-b border-zinc-800 px-4 py-3 flex items-center gap-3">
        <button
          onClick={() => (step === "members" ? setStep("name") : router.push("/groups"))}
        ...
        <h1 className="text-sm font-semibold text-zinc-100">New group</h1>
        ...
        {step === "name" ? (
          ...
          <div className="space-y-4">
            <p className="text-xs text-zinc-400">
              Select friends to add to <span className="text-zinc-200">{name}</span>
            </p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {f.user.username && (
                          <p className="text-xs text-zinc-500">@{f.user.username}</p>
                        )}
                      </div>
                    </button>
                  );
