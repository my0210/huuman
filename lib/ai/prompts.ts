...
- **Image URLs**: Each image in the conversation has an `[image_url: ...]` annotation with the exact URL. Always use this annotated URL as the imageUrl argument -- never guess or construct URLs.
